  ...
  const customBgContent = (
    <div className="max-w-80">
      <div>
        ...
        ：སྙིང་ལ་དགའ་བའི་རིམ་འགྱུར་མདོག་ CSS བཟོ་ལྟ་སྒྲིག་འགོད་པར་འདྲ་བཤུས་བྱོས།
      </div>
      <div className="mt-2">
        <Link href="https://cssgradient.io/" target="_blank">
          cssgradient.io
        </Link>
        ： དྲ་ཐོག་ལག་ཆས་བེད་སྤྱད་དེ་རིམ་འགྱུར་མདོག་བཟོ་བཟོ།
      </div>
      <TextArea
        value={customBg}
        onChange={(text) => {
        ...
        className="mt-4"
        rows={6}
        placeholder="བཟོ་ལྟ་སྒྲིག་འགོད་སྦྱར་བརྗེ།"
      />
    </div>
  );
        ...
        {type === "color" ? (
          <div className="mt-4 flex justify-between items-center space-x-4">
            ...
            <Popconfirm
              ...
              title="རང་འགུལ་གྱི་བཟོ་ལྟ་སྒྲིག་འགོད།"
              trigger="click"
              okText="གཏན་འཁེལ།"
              cancelText="ཕྱིར་འཐེན།"
        ...
        {type !== "custom" ? (
          ...
          <div className="mt-4">
            <Dragger onChange={onUpload} showUploadList={false}>
              ...
              <div className="mt-2">རི་མོ་འདིར་འདྲུད་འཐེན་བྱོས།</div>
            </Dragger>
          </div>
        )}
      </div>
